...
<div id="MainForm">
    <div class="form_boxA">
        ...
        <div class="txtbox floatL mag_r20">
            <form action="getStuByClass" method="post" onsubmit="return check()" >
            <span class="sttl">选择班级：<select id="classid" name="classId" style="height: 29px">
                ...
                <span class="sttl">选择日期<input id="idate" name="interviewDate" type="date" value="" /></span>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <c:forEach items="${list.list}" var="temp">
                <tr>
                    ...
                    <td>${temp.interviewDate}</td>
                    <td>${temp.interviewContent}</td>
                    <td><a href="getIntById?id=${temp.interviewId}">修改</a></td>
                </tr>
            </c:forEach>
...
<!-- PageNum -->
<ul id="PageNum">
    <li><a href="interview?cPage=${list.firstPage}">首页</a></li>
    <li><a href="interview?cPage=${list.prePage}">上一页</a></li>
    <li><a href="interview?cPage=${list.nextPage}">下一页</a></li>
    <li><a href="interview?cPage=${list.lastPage}">尾页</a></li>
