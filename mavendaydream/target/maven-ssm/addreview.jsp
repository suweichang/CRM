...
<form method="post" action="addreview">
    ...
    <div id="SubPopup">
        <div class="form_boxC">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <th>评审名称</th>
                    <td><input type="text" name="review_name"style="border: 0px;"/></td>
                </tr>
                <tr>
                    <th>评审老师</th>
                    <td>
    ...
    <div id="BtmBtn">
        <a href="review"><div class="btn_boxB floatR mag_l20"><input name="" type="button" value="返回" onmousemove="this.className='input_move'" onmouseout="this.className='input_out'"></div></a>
